<script lang='ts'>
    ...
    import {height, editorState, consolePanelState, consoleMessages, filesLocalCopy, bgColor, textColor, runCode} from '$lib/store'
...
<div class='container' style='height: 100%;'>
    ...
    <div class='editorContainer' style='height: {$consolePanelState && mode==='javascript' && !readOnly ? "calc(100% - 130px)" : "calc(100% - 0px)"}; background: hsl({$bgColor}); color: hsl({$textColor}); border: 1px solid hsl({$textColor + ', 20%'}); box-sizing: border-box;'>
