...
export let threadsList:any = writable([])
export let isSavingThread = writable(false)
export let manual = writable(false)
export let tutorials = writable(false)
export let templates = writable(false)
export let apps = writable(false)

export let chatModel = writable('gpt-4o')
export let visionModel = writable('gpt-4o')
export let imageModel = writable('flux-schnell')
export let imageCompositionReferenceModel = writable('brick-style')
export let videoModel = writable('video-01')
export let modelModel =writable('trellis')
export let frameInterpolationModel = writable('amt-interpolation')
