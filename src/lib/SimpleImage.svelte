	...
	{#if !isGenerating}
		<details>
			...
			<ul>
				...
				<li>
					<a href={imageUrl} download="image.png" target="_blank" class="settingsButton" style='padding: 0 5px; color: #1a1a1a; text-decoration: none; margin: 10px 0; display: block;'
						>Download</a
					>
				</li>
				<li>
