<script>
    ...
    import { bgColor, textColor, width, height, tutorialsPanelState } from "./store"
...
<nav style='color: {$textColor};'>
    {#if $width > 700}
        <div style='width: 100%; display: flex; align-items: center; justify-content: space-between;'>
            ...
            <div class='desktopMenu'>
                <button class='smallMenuButton' on:click={toggleTutorials}>Resources</button>
                {#if data.user}
    ...
    {:else}
        ...
        <div class='mobileMenu' style='display: {mobileMenuDisplay}; height: calc({$height}px - 80px);'>
            ...
            <button class='smallMenuButton' on:click={()=>{toggleTutorials(); mobileMenuDisplay = 'none'}}>Resources</button>
